...
export const emailTemplates = [
  {
    ...
    generateSubject: (data) =>
      `📅 Reminder: Your ${data.subscriptionName} Subscription Renews in 30 days!`,
    generateBody: (data) => generateEmailTemplate({ ...data, daysLeft: 30 }),
  },
  {
    label: "14 days before reminder",
    generateSubject: (data) =>
      `📅 Reminder: Your ${data.subscriptionName} Subscription Renews in 14 Days!`,
    generateBody: (data) => generateEmailTemplate({ ...data, daysLeft: 14 }),
  },
  {
